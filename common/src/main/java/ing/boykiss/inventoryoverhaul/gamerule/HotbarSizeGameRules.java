...
public class HotbarSizeGameRules {
    public static final GameRules.Key<GameRules.IntegerValue> HOTBAR_SIZE_X = GameRules.register("hotbarSizeX", GameRules.Category.PLAYER, InvokerIntegerValue.invokeCreate(9, 1, 6, FeatureFlagSet.of(), HotbarSizeGameRules::resizeHotbarX));
    public static final GameRules.Key<GameRules.IntegerValue> HOTBAR_SIZE_Y = GameRules.register("hotbarSizeY", GameRules.Category.PLAYER, InvokerIntegerValue.invokeCreate(1, 1, 6, FeatureFlagSet.of(), HotbarSizeGameRules::resizeHotbarY));
